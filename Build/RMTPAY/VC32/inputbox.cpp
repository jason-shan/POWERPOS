...
WORD uBtnID;
	...
	case WM_CREATE:
		...
		_hBtnOk = ::CreateWindowEx(0,"Button","确定(&K)",WS_CHILD | WS_VISIBLE | BS_DEFPUSHBUTTON,
						285,5,65,20,hWnd,(HMENU)IDOK,_hInstance,0);
		_hBtnCancel = ::CreateWindowEx(0,"Button","取消(&C)",WS_CHILD | WS_VISIBLE,
						285,30,65,20,hWnd,(HMENU)IDCANCEL,_hInstance,0);
		_hBtnHelp = ::CreateWindowEx(0,"Button","帮助(&H)",WS_CHILD | WS_VISIBLE,
